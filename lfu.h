...
static PyMethodDef LFUCache_methods[] = {
    ...
    { "setdefault", (PyCFunction)LFUCache_setdefault, METH_VARARGS | METH_KEYWORDS, NULL },
    ...
    { "update", (PyCFunctionWithKeywords)LFUCache_update, METH_VARARGS | METH_KEYWORDS, NULL },
